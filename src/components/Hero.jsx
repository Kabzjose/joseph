...
export default function Hero() {
  ...
  return (
    <section
      id="about"
      className="relative flex min-h-screen items-center overflow-hidden bg-[radial-gradient(circle_at_8%_12%,rgba(16,185,129,0.22),transparent_36%),radial-gradient(circle_at_88%_72%,rgba(14,165,233,0.24),transparent_32%),linear-gradient(160deg,#e8f4ff_0%,#f8fafc_45%,#e9efff_100%)] px-6 pt-24 dark:bg-[radial-gradient(circle_at_8%_12%,rgba(16,185,129,0.15),transparent_35%),radial-gradient(circle_at_88%_72%,rgba(59,130,246,0.18),transparent_30%),linear-gradient(160deg,#020617_0%,#0b1327_45%,#111827_100%)]"
    >
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 md:grid-cols-[1.2fr_0.8fr]">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full border border-emerald-400/80 bg-white px-4 py-1 font-mono text-[11px] tracking-[0.24em] text-emerald-800 shadow-sm dark:border-emerald-300/20 dark:bg-emerald-500/10 dark:text-emerald-200">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a
              href="#contact"
              className="rounded-lg border border-emerald-600/50 bg-white px-6 py-3 font-mono text-xs tracking-[0.14em] text-emerald-800 transition hover:-translate-y-0.5 hover:border-emerald-600 dark:border-emerald-300/40 dark:bg-slate-900/50 dark:text-emerald-200"
            >
              GET IN TOUCH
            </a>
          </div>
          ...
          <div className="mt-8 grid max-w-lg grid-cols-2 gap-3 text-xs sm:grid-cols-3">
            <div className="rounded-lg border border-slate-300 bg-white px-3 py-2 dark:border-slate-700 dark:bg-slate-900/70">
            ...
            <div className="col-span-2 rounded-lg border border-slate-300 bg-white px-3 py-2 sm:col-span-1 dark:border-slate-700 dark:bg-slate-900/70">
        ...
        <div className="relative mx-auto w-full max-w-sm">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-3 shadow-2xl dark:border-slate-700 dark:bg-slate-900/70">
            <img
              src={image}
              alt="Joseph Ndungu profile"
              className="h-[420px] w-full rounded-[1.4rem] object-cover"
            />
            <div className="mt-3 rounded-xl border border-sky-300 bg-white p-3 dark:border-slate-700 dark:bg-slate-900/80">
